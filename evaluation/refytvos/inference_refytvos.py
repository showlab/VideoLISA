...
def parse_args(args):
    ...
    parser.add_argument("--vis_save_path", default="./results/VideoLISA-RefYTVOS/", type=str)
...
def main(args):
    ...
    # ---------------------------- read data ------------------------------------
    meta_exp_path = "/data_sdf/LLM_DATA/video_centric/RefVOS/refer_youtube_vos/meta_expressions/valid/meta_expressions.json"
    meta_exp = json.load(open(meta_exp_path, 'r'))
    video_folder = "/data_sdf/LLM_DATA/video_centric/RefVOS/refer_youtube_vos/valid/JPEGImages"
