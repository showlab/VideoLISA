...
def parse_args(args):
    ...
    parser.add_argument("--vis_save_path", default="./results/VideoLISA-RefDAVIS/", type=str)
...
def main(args):
    ...
    # ---------------------------- read data ------------------------------------
    meta_exp_path = "/data_sdf/LLM_DATA/video_centric/ref-davis/meta_expressions/valid/meta_expressions.json"
    meta_exp = json.load(open(meta_exp_path, 'r'))
    video_folder = "/data_sdf/LLM_DATA/video_centric/ref-davis/valid/JPEGImages"
